...
from crispedit.mask.candidates import select_object_candidate, topology, use_object_selection
...
def test_single_object_collapsed_extent_can_recover_supported_visual_candidate():
    import numpy as np
    from crispedit.mask.candidates import select_object_candidate
