...
from scaleedit.mask.attachments import attachment_phrase, complete_supported_holes


def test_container_completion_requires_actual_content_support_inside_envelope():
    from scaleedit.mask.attachments import container_envelope, container_contents
...
def test_content_seam_cleanup_preserves_unrelated_openings_and_outer_boundary():
    from scaleedit.mask.attachments import close_content_seams
...
def test_content_crossing_rim_only_adds_supported_pixels_inside_envelope():
    ...
    rim[10:90,10:90] = 1
    rim[30:70,30:100] = 0
    from scaleedit.mask.attachments import container_envelope
    envelope = container_envelope(rim)
