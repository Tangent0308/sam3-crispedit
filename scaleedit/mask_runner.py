...
INSTANCE_TYPE = pa.struct(
    [
        ...
        ("completion_applied", pa.bool_()),
        ("completion_rule", pa.string()),
        ("completion_radius", pa.int32()),
        ("completion_added_area", pa.int64()),
        ("completion_filled_hole_area", pa.int64()),
        ("completion_component_count_before", pa.int32()),
        ("completion_component_count_after", pa.int32()),
        ("sam_prompt", pa.string()),
        ("region_mode", pa.string()),
        ("selection_mode", pa.string()),
        ("mask_extent", pa.string()),
        ("expected_count", pa.int32()),
