...
from scaleedit.mask.checklist import observation_prompt, grounding_prompt, flatten_edit_units, strict_json
...
def canonicalize_type(raw_type):
    ...
    if value not in GROUNDING_ROUTES:
        raise ValueError(f'Unsupported mask operation: {raw_type!r}')
    return value
