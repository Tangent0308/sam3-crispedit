"""One-call image-pair quality assessment schema and prompt for ScaleEdit."""
...
from scaleedit.common import canonical_edit_type


PREFILTER_METHOD = "pair_quality"
EVIDENCE_SCHEMA = "pair_quality_dimensions"
PROMPT_VERSION = "scaleedit_pair_quality"
...
QUALITY_PROMPT = """You are a strict but fair quality auditor for a ScaleEdit image-editing dataset.
